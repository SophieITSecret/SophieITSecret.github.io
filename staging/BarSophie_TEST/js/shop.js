/**
 * shop.js — 真・完全復元版
 * ★ 初代MrP2の全ボタン・全スタイルを保持し、商品名の改行のみ修正
 */
...
export function openShop() {
    ...
    h += `<a href="${getSaleUrl('水 ミネラルウォーター')}" target="_blank" class="act-btn" style="flex:1; min-width:28%; background:#111; border:1px dashed #555; color:#aaa!important; font-size:0.8rem; margin-bottom:0; height:36px; display:flex!important; align-items:center; justify-content:center; text-decoration:none; padding:0 4px;">💧 水</a>`;
