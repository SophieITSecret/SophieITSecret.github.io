...
P1　ご利用案内 showWelcomePage()　← O → O-G → ご利用案内 から
...
- **P1・P2** は O-G経由のほかヘッダーからも直接アクセス可
- **X（お酒の話/探す）** は C ルートの統合ボタンから L1・N1 を選択する中間メニュー
- **O-G（このお店のご案内）** は旧「ご利用案内」「このお店の使い方」の統合サブメニュー
