...
function openMusic() {
    nav.updateNav("art"); menuL.style.display = 'flex'; menuL.classList.remove('single-col');
...
function renderSongs(a) {
    ...
    menuL.classList.add('single-col'); let h = `<div class="genre-label">${a}</div>`;
...
function openTalk() {
    nav.updateNav("g"); menuL.style.display = 'flex'; menuL.classList.remove('single-col');
...
function renderThemes(g) {
    nav.updateNav("th"); menuL.classList.add('single-col'); let h = `<div class="genre-label">${g}</div>`;
